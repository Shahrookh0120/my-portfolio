...
const CareerHistory = () => {
	return (
		<>
			<h1 className="heading text-center my-14 text-xl xl:text-[60px]">
				Career history
			</h1>

			<div className="xl:h-['auto'] w-full dark:bg-[#111a2d  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center">
				...
				<div className="w-[100%]">
					<div className="max-sm:w-[100%] w-[100%] flex flex-wrap xl:flex-nowrap justify-end items-center gap-5 p-[20px]">
					...
					<div className="max-sm:w-[100%] w-[100%] flex xl:hidden flex-col justify-center items-center">
						<img className="w-[50%] mx-auto" src={Code} alt="" />
					</div>
				</div>
			</div>
		</>
